...
if (image_index=8) segafadeto(ta_menu,"systemstart") //time attack menu coming soon
//if (image_index=9) {if (!rosterctrl.cog) sound("systemselect") rosterctrl.cog=1}
if (image_index=10) url_open("https://x.com/boll_deluxe")
if (image_index=11) url_open("https://discord.gg/DfZYkFTa6T")